  ...
  it('Ad',() => {
    ...
    cy.url().then(($el) => {
      if ($el=='https://staging.sanasafinaz.com/pk'||$el=='https://staging.sanasafinaz.com/us'||$el=='https://staging.sanasafinaz.com/uk'||$el=='https://staging.sanasafinaz.com/eu'||$el=='https://staging.sanasafinaz.com/gcc')  {
        ...
        cy.get('#bafl_card').as('alfalahCard')
        cy.get('@alfalahCard').click()
        cy.get('#checkout-payment-method-load > div > div > div.payment-method._active > div.payment-method-content > div.actions-toolbar > div > button').contains('Place Order').click()
